...
public class OrderServiceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAllExceptions(Exception e, WebRequest webRequest){
        OrderServiceExceptionResponse response = new OrderServiceExceptionResponse(e.getMessage(),
    ...
    public ResponseEntity<Object> handleIncorrectRequest(Exception e, WebRequest webRequest){
        OrderServiceExceptionResponse response = new OrderServiceExceptionResponse(e.getMessage(),
                webRequest.getDescription(false),
    ...
    public ResponseEntity<Object> handleResourceNotFound(Exception e, WebRequest webRequest){
        OrderServiceExceptionResponse response = new OrderServiceExceptionResponse(e.getMessage(),
                webRequest.getDescription(false),
